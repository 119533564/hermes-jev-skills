...
- **Live**: every Jev decision as it happens, across all profiles: tier, kind of work, the model it went to, confidence, Jev's latency. Decisions only; the text of a turn is never logged or shown.
